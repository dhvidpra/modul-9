...
if($_GET['id']){
    ...
    if(strtotime($dt_pinjam['tanggal_mengembalikan'])>=strtotime(date('Y-m-d'))){
    ...
    mysqli_query($conn, "insert into pengembalian_buku (id_pembelian_produk, tanggal_pengembalian,denda) value('".$id_peminjaman_buku."','".date('Y-m-d')."','".$denda."')");
